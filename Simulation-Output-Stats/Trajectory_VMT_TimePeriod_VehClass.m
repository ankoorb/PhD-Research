...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
    ...
    for i=1:2
        s1=int2str(i);
        s2=strcat('VMT_Class_',s1,'.csv'); % Col-1: Art, Col-2: Fwy
    ...
    s6=strcat('HDT_VMT.csv');
    csvwrite(s6,HDT);
    
    s1=int2str(17);
    s2=strcat('VMT_Class_',s1,'.csv'); % Col-1: Art, Col-2: Fwy    
    PHDT = load(s2);
    s7=strcat('PHDT_VMT.csv');
    csvwrite(s7,PHDT);
