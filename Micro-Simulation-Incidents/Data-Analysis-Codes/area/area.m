...
filename = 'Speed.xls';                                     % use this if reading from an Excel file
...
while column > 2            % delete all zeroes at the end of the dataset
   ...
   axis([rxneg-1 rxpos+90 ryneg-1 rypos+90]); % set the limits of the axes to slightly larger than the actual data limits
    hold on;
