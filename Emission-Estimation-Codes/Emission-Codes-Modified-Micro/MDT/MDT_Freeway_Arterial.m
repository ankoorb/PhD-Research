...
s3=strcat('MDT_Freeway_Emission_',s1,'.csv');
s4=strcat('MDT_Arterial_Emission_',s1,'.csv');
...
for b=1:96
    s5=int2str(b);
    s6=strcat('MDT_Freeway_Emission_',s5,'.csv');
    s7=strcat('MDT_Arterial_Emission_',s5,'.csv');
...
s9=strcat('MDT_Freeway_Time_Period.csv');
s10=strcat('MDT_Arterial_Time_Period.csv');
